...
from v3.models.random_forest import fit_probability, fit_regression, predict_fold
...
class RandomForestTests(unittest.TestCase):
    ...
    def test_fold_benchmark_produces_common_interface(self) -> None:
