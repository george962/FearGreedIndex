...
The hashes in `manifest.json` identify the exact runtime, inputs, generator, and reports. Any methodology change belongs in v3 rather than changing this benchmark.
