...
def evaluate_model(
    ...
    for fold in folds:
        ...
        relative_brier = float((baseline_brier - brier) / baseline_brier) if baseline_brier > 0 else float("nan")
    ...
    return metrics, predictions, summarize_model(metrics)
...
def run() -> dict[str, Any]:
    ...
    sample_hashes_match = bool(metrics.groupby("fold")["sample_sha256"].nunique().eq(1).all())
    ...
    report = {
        ...
        "models": {LOGISTIC_NAME: logistic_summary, RF_NAME: rf_summary},
