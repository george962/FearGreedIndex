...
def main() -> int:
    ...
    # The frozen manifest is itself part of the evidence contract. Cross-check its
    # human-facing result block against regenerated machine-readable evidence so a
    # stale or manually edited conclusion cannot pass merely because report hashes match.
